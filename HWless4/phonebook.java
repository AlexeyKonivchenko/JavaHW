...
public class phonebook {
    ...
    public static void main(String[] args) {
        ...
        phoneBook.put("Alex", phoneMemo1);
        phoneBook.put("Dan", phoneMemo2);
        phoneBook.put("Martin", phoneMemo3);

        System.out.println("Добро пожаловать в телефонную книгу." +
                "Введите соответствующее число меню:\n" +
        ...
        switch (n) {
            case "1":
                ...
                break;
            case "2":
                System.out.println("Введите логин нового абонента: ");
                String a = userInput.nextLine();
                System.out.println(
                        "Введите телефон нового абонента. Если номеров несколько, то введите их через запятую и пробел: ");
                ...
                break;
            case "3":
                System.out.println("Введите номер телефона, который нужно удалить: ");
            ...
            case "4":
                ...
                System.out.println("Введите логин для поиска номера телефона: ");
            ...
            case "5":
                ...
                System.out.println("Введите номер телефона для поиска логина: ");
